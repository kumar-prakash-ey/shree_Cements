...
import com.scl.test.constants.SclTestConstants;
import com.scl.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SclTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/scltest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/scltest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/scltest/import/cstickets.impex");
			...
			importImpexFile(context, "/scltest/import/csquotes.impex");
		}
	}
}
