...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sclstorefront/electronics/en",
						"https://electronics.local:9002/sclstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sclstorefront/electronics/en",
						"https://electronics.local:9002/sclstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sclstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/sclstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sclstorefront/electronics/en",
						"https://electronics.local:9002/sclstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sclstorefront",
						"https://electronics.local:9002/sclstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sclstorefront",
						"https://electronics.local:9002/sclstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/sclstorefront/electronics/en",
						"https://electronics.local:9002/sclstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
