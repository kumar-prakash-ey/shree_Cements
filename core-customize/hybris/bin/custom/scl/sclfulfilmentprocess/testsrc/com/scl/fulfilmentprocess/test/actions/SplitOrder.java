 ...
 */
package com.scl.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SclFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SclFulfilmentProcessConstants.PARENT_PROCESS);
